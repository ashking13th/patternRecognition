...
sourcePath = "../dataset/prep/2b/bovw/train"
targetP = "../output/prep/2b/old/train"
...
sourceFile = sourcePath + "_" + classNames[int(args["classNum"])] + ".bovw"
targetFile = targetP + "_" + classNames[int(args["classNum"])] + "_C"
